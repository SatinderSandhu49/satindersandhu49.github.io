$(document).ready(function () {
    ...
    $(".animated-text").typed({
        strings: [
            "The Winter Home Buyers Festival (PreSales + Huge Discounts)",
            "Meet Industry Experts in House Mortgages and Insurance",
            "Take Away the Best Deals in the Housing Market",
            "Book a House in the PreSale Discount Festival"
        ],
        typeSpeed: 40,
        loop: true,
    });
